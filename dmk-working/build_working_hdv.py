...
inconsistent with the directory entry it creates for it (see SESSION_STATUS.md
and omti_protocol_bugs.md for the full characterization). This script instead
